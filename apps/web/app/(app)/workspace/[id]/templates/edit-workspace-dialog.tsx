...
export default function EditProjectDialog({
  ...
  return (
    <Dialog
      ...
      description="Update your workspace's settings and email provider."
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <FormField
          label="Workspace Name"
          required
          hint="Update the internal name of this workspace"
        >
          <Input
            name="name"
        ...
        <FormField
          ...
          hint="Update the description of this workspace"
        >
          <Textarea
            name="description"
